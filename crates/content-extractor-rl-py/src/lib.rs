// ============================================================================
// FILE: crates/content-extractor-rl-py/src/lib.rs
// ============================================================================
...
impl RustArticleExtractor {
    ...
    fn new(_site_profile: Option<String>, model: Option<String>) -> PyResult<Self> {
        ...
        let device = content_extractor_rl::device::get_device();
        let device_info = content_extractor_rl::device::get_device_info(&device);

        // Use println! to ensure it reaches Python's stdout
        println!("╔═══════════════════════════════════════╗");
        println!("║  Content Extractor RL - Initialization    ║");
        println!("╠═══════════════════════════════════════╣");
...
#[pymodule]
fn content_extractor_rl_rs(m: &Bound<'_, PyModule>) -> PyResult<()> {
